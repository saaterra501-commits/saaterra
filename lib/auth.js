...
export const ADMIN_EMAILS = [
  ...
  'founder@stackdeal.in',
  'saaterra501@gmail.com',
  'tiwariujjawal9839@gmail.com',
  'stackdeal30@gmail.com',
];
  ...
  try {
    ...
    if (decoded) {
      if (decoded.role === 'admin') {
        // already admin
      } else if (decoded.email && ADMIN_EMAILS.includes(decoded.email.toLowerCase())) {
        decoded.role = 'admin';
      }
    }
    return decoded;
