...
const TOP_CATEGORIES = [
  ...
  },
  {
    ...
    name: 'Fashion',
    categoryKey: 'Fashion',
    image: 'https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'credit-cards',
    name: 'Credit Cards',
    categoryKey: 'Credit Cards',
    image: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'beauty-grooming',
    name: 'Beauty & Grooming',
    categoryKey: 'Beauty & Grooming',
    image: 'https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'home-kitchen',
    name: 'Home & Kitchen',
    categoryKey: 'Home & Kitchen',
    image: 'https://images.unsplash.com/photo-1570222094114-d054a817e56b?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'electronics',
    name: 'Electronics',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'mobiles',
    name: 'Mobiles',
    categoryKey: 'Mobiles',
    image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'pharmacy',
    name: 'Pharmacy',
    categoryKey: 'Pharmacy',
    image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=250&q=80',
  },
  {
    id: 'min-50-cashback',
...
export default function HeroDealSlider({
  ...
  return (
    <section className="cashkaro-exact-hero w-full bg-white pt-6 pb-6 select-none overflow-hidden">
      ...
      >
        ...
        {canScrollLeft && (
          <button
            ...
            className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white text-slate-800 shadow-xl border border-slate-200/90 flex items-center justify-center hover:bg-slate-50 hover:scale-105 active:scale-95 transition-all z-30 cursor-pointer absolute left-6 sm:left-10 top-1/2 -translate-y-1/2"
        ...
        <button
          onClick={() => handleScroll(430)}
          className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white text-slate-800 shadow-xl border border-slate-200/90 flex items-center justify-center hover:bg-slate-50 hover:scale-105 active:scale-95 transition-all z-30 cursor-pointer absolute right-6 sm:right-10 top-1/2 -translate-y-1/2"
        ...
        >
          {CASHKARO_BANNERS.map((banner) => (
            <Link
              key={banner.id}
              href={banner.href}
              className={`relative flex-shrink-0 w-[335px] sm:w-[390px] lg:w-[425px] h-[190px] sm:h-[215px] rounded-[20px] bg-gradient-to-r ${banner.gradient} p-5 sm:p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 overflow-hidden flex flex-col justify-between cursor-pointer group`}
            >
              ...
              <div className="z-10 my-auto">
                <h3 className={`text-2xl sm:text-3xl lg:text-[34px] font-black tracking-tight leading-none drop-shadow-xs ${banner.textColor || 'text-white'}`}>
                  {banner.discount}
                </h3>
                <p className={`text-xs sm:text-sm font-semibold mt-1.5 line-clamp-1 ${banner.textColor ? 'text-slate-800' : 'text-white/90'}`}>
                  {banner.subtitle}
                </p>
              </div>
              ...
              <div className="z-10 flex items-center justify-between">
                <div className={`inline-flex items-center gap-2 ${banner.pillBg} text-white px-3 py-1.5 rounded-lg text-xs font-bold shadow-xs border border-white/15`}>
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 w-[140px] sm:w-[170px] h-[140px] sm:h-[160px] pointer-events-none flex items-center justify-center">
                {banner.logoType === 'flipkart' && (
                  <div className="relative w-full h-full flex items-center justify-end">
                    {/* Backpack */}
                    <div className="absolute right-12 top-1 w-20 h-28 rounded-xl overflow-hidden shadow-xl transform rotate-3">
                      <img src={banner.products.bagImg} alt="Bag" className="w-full h-full object-cover" />
                    </div>
                    {/* Blue Running Shoe */}
                    <div className="absolute right-0 bottom-1 w-24 h-20 rounded-xl overflow-hidden shadow-2xl transform -rotate-12 z-10 border-2 border-white/40">
                      <img src={banner.products.shoeImg} alt="Shoe" className="w-full h-full object-cover" />
                    </div>
                    {/* Luxury Watch */}
                    <div className="absolute right-16 bottom-0 w-12 h-12 rounded-full overflow-hidden shadow-lg z-20 border-2 border-white">
                ...
                {banner.logoType === 'amazon' && (
                  <div className="relative w-full h-full flex items-center justify-end">
                    ...
                    <div className="absolute right-8 top-1 w-20 h-20 rounded-2xl overflow-hidden shadow-xl transform -rotate-6">
                      <img src={banner.products.headphoneImg} alt="Headphones" className="w-full h-full object-cover" />
                    </div>
                    {/* White Sneaker */}
                    <div className="absolute right-0 bottom-2 w-24 h-20 rounded-xl overflow-hidden shadow-2xl transform rotate-6 z-10 border-2 border-white/40">
                      <img src={banner.products.sneakerImg} alt="Sneaker" className="w-full h-full object-cover" />
                    </div>
                    {/* Smartphone */}
                    <div className="absolute right-16 bottom-1 w-11 h-18 rounded-lg overflow-hidden shadow-lg z-20 border-2 border-white">
                ...
                {banner.logoType === 'nykaa' && (
                  <div className="relative w-full h-full flex items-center justify-end">
                    ...
                    <div className="absolute right-8 top-1 w-16 h-28 rounded-xl overflow-hidden shadow-xl transform rotate-6">
                      <img src={banner.products.serumImg} alt="Serum" className="w-full h-full object-cover" />
                    </div>
                    {/* Skincare Bottle */}
                    <div className="absolute right-0 bottom-2 w-16 h-20 rounded-xl overflow-hidden shadow-2xl transform -rotate-6 z-10 border-2 border-white/60">
                ...
                {banner.logoType === 'myntra' && (
                  <div className="relative w-full h-full flex items-center justify-end">
                    <div className="absolute right-4 top-2 w-24 h-24 rounded-xl overflow-hidden shadow-xl transform rotate-6">
                ...
                {banner.logoType === 'croma' && (
                  <div className="relative w-full h-full flex items-center justify-end">
                    <div className="absolute right-4 top-2 w-28 h-24 rounded-xl overflow-hidden shadow-xl transform -rotate-6">
      ...
      {/* ── 2. TOP CATEGORIES SECTION (Exact Re-creation of user's screenshot) ── */}
      <div className="w-full px-4 sm:px-8 lg:px-12 pt-7 pb-4">
        ...
        {/* Circular Category Items Row (Full Width Scrollable) */}
        <div className="flex items-start gap-5 sm:gap-7 overflow-x-auto scrollbar-none pb-2 pt-1 w-full">
          {TOP_CATEGORIES.map((cat) => {
            ...
            return (
              ...
              >
                ...
                {cat.isMostPopular && (
                  <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#0052cc] border-2 border-blue-400 text-yellow-300 font-black text-center flex flex-col items-center justify-center shadow-xs group-hover:scale-105 group-hover:shadow-md transition-all duration-200 ${
                    activeCat === 'All' ? 'ring-4 ring-blue-300 scale-105' : ''
                  }`}>
                    <span className="text-[12px] sm:text-[14px] leading-tight font-black tracking-tight text-yellow-300">
                      MOST
                    </span>
                    <span className="text-[12px] sm:text-[14px] leading-tight font-black tracking-tight text-yellow-300">
                      POPULAR
                ...
                {!cat.isMostPopular && !cat.isMinCashback && (
                  <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white border border-slate-200/90 shadow-2xs flex items-center justify-center overflow-hidden p-1.5 group-hover:scale-105 group-hover:shadow-md transition-all duration-200 ${
                ...
                <span className={`text-xs sm:text-[13px] font-bold mt-2.5 max-w-[85px] sm:max-w-[100px] leading-tight transition-colors ${
