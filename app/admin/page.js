...
const METRICS = [
  ...
  { label: 'StackDeal Net Revenue (30%)', value: '₹4,45,200', change: '+28.0%', icon: TrendingUp, color: 'text-[#2475FF]', bg: 'bg-blue-500/10' },
  { label: 'Active 5-Year Deals', value: '12 Deals', change: '3 Pending', icon: Tag, color: 'text-amber-400', bg: 'bg-amber-500/10' },
...
const RECENT_ORDERS = [
  ...
  { id: 'ord_1087', buyer: 'Priya Mehta (SEO Agency)', deal: 'Nuwatomic GEO SEO', price: '₹2,499', gstin: '29BBBBB8888C1Z4', status: 'Completed', date: '12 mins ago' },
  { id: 'ord_1086', buyer: 'Amit Patel (Consultant)', deal: 'LeadExtractor AI', price: '₹1,499', gstin: '24CCCCC7777D1Z1', status: 'Completed', date: '45 mins ago' },
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/5 border border-white/10 p-5 rounded-2xl">
        <div>
          <h2 className="text-xl font-black text-white">Executive Command Overview</h2>
          <p className="text-xs text-slate-400 font-medium">Real-time marketplace revenue, active deals, and vendor payouts.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/admin/vendors"
            className="flex items-center gap-2 px-4 py-2.5 bg-[#2475FF] hover:bg-blue-600 text-white text-xs font-black rounded-xl transition-all shadow-md"
          >
      ...
      <div className="bg-[#070B16] border border-white/10 rounded-2xl p-6 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/admin/orders" className="text-xs font-bold text-[#2475FF] hover:underline flex items-center gap-1">
            ...
            <tbody className="divide-y divide-white/5">
              {RECENT_ORDERS.map((ord) => (
                <tr key={ord.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="p-3 font-bold text-white">{ord.buyer}</td>
                  ...
                  <td className="p-3">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-1 text-[11px] font-bold text-[#2475FF] hover:underline"
                    >
                      <Download className="w-3 h-3" /> View GST PDF
                    </a>
                  </td>
